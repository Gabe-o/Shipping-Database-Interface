...
const ShipInsertPopup = ({ buttonState }) => {
        ...
        <React.Fragment>
            {
                <React.Fragment>
                    ...
                    <div className="popup">
                        ...
                        <h1 className='header'>Create Ship Form</h1>
...
export default ShipInsertPopup;