...
const RouteInsertPopup = ({ buttonState }) => {
    ...
    const handleSubmit = (event) => {
        ...
        fetch("/api/routes", { method: "POST", body: JSON.stringify({ "startingPortNo": inputs.startingPortNo ? inputs.startingPortNo : null, "endingPortNo": inputs.endingPortNo ? inputs.endingPortNo : null, "distance": inputs.distance ? inputs.distance : null }), headers: new Headers({ 'Content-Type': 'application/json' }) })
            .then(res => {
